...
说明：学习ES6的语法，主要是参考[阮一峰](https://es6.ruanyifeng.com/)老师的文章。
...
17. [Generator 函数的语法](https://es6.ruanyifeng.com/#docs/generator)
...
23. [Module 的加载实现](https://es6.ruanyifeng.com/#docs/module-loader)
24. [编程风格](https://es6.ruanyifeng.com/#docs/style)
25. [读懂规格](https://es6.ruanyifeng.com/#docs/spec)
26. [异步遍历器](https://es6.ruanyifeng.com/#docs/async-iterator)
27. [ArrayBuffer](https://es6.ruanyifeng.com/#docs/arraybuffer)
28. [最新提案](https://es6.ruanyifeng.com/#docs/proposals)
29. [Decorator](https://es6.ruanyifeng.com/#docs/decorator)